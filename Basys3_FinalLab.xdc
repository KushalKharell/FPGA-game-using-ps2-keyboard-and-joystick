...
set_property PACKAGE_PIN W15 [get_ports {PlayerColor[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {PlayerColor[0]}]
set_property PACKAGE_PIN V15 [get_ports {PlayerColor[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {PlayerColor[1]}]
set_property PACKAGE_PIN W14 [get_ports {PlayerColor[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {PlayerColor[2]}]
set_property PACKAGE_PIN W13 [get_ports {PlayerColor[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {PlayerColor[3]}]
set_property PACKAGE_PIN V2 [get_ports {PlayerColor[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {PlayerColor[4]}]
set_property PACKAGE_PIN T3 [get_ports {PlayerColor[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {PlayerColor[5]}]
#set_property PACKAGE_PIN T2 [get_ports {PlayerColor[6]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {PlayerColor[6]}]
...
set_property PACKAGE_PIN U18 [get_ports reset]						
	set_property IOSTANDARD LVCMOS33 [get_ports reset]
set_property PACKAGE_PIN T18 [get_ports PushUp]						
	set_property IOSTANDARD LVCMOS33 [get_ports PushUp]
##set_property PACKAGE_PIN W19 [get_ports btnL]						
##	set_property IOSTANDARD LVCMOS33 [get_ports btnL]
##set_property PACKAGE_PIN T17 [get_ports btnR]						
##	set_property IOSTANDARD LVCMOS33 [get_ports btnR]
set_property PACKAGE_PIN U17 [get_ports PushDown]						
	set_property IOSTANDARD LVCMOS33 [get_ports PushDown]
